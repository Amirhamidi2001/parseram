...
class Product(models.Model):
    ...
    category = models.EmbeddedField("Category", on_delete=models.CASCADE, null=True)
...
class OrderDetail(models.Model):
    ...
    """
    o = models.EmbeddedField("Order", on_delete=models.CASCADE, null=True)
    product = models.EmbeddedField("Product", on_delete=models.CASCADE)
...
class Order(models.Model):
    ...
    """
    user = models.EmbeddedField("Customer", on_delete=models.CASCADE)
